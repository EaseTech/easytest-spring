 ...
 * <br>
 * 
 * then, {@link OldSpringTestRunner}, will provide the details of the executing test method in the JUnit supported IDEs
 * like this:
 * 
 * <ul>
 ...
 */
@Deprecated
public class OldSpringTestRunner extends BaseSuite {


    /**
     * An instance of logger associated with the test framework.
     */
    protected static final Logger PARAM_LOG = LoggerFactory.getLogger(OldSpringTestRunner.class);
    

    /**
     * 
     * Construct a new {@link OldSpringTestRunner}. During construction, we will load the test data, and then we will
     ...
     */
    public OldSpringTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
